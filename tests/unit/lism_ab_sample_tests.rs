...
fn r1_1_summarize_context_tier_and_hydration_metrics_per_arm() {
    ...
    on_report.observability_summary = Some(BossObservabilitySummary {
        ...
        total_hydration_ref_missing: 2,
        total_tool_dispatch_count: 4,
        total_tool_dispatch_success_count: 3,
        total_tool_dispatch_failure_count: 1,
        total_tool_dispatch_ref_write_count: 6,
        tool_dispatch_failure_taxonomy: Default::default(),
        override_hit_count: 0,
    ...
    on_report.steps[0].routed_metadata = Some(BossStepRoutedMetadata {
        ...
        hydration_ref_missing: Some(2),
        tool_dispatch_count: Some(4),
        tool_dispatch_success_count: Some(3),
        tool_dispatch_failure_count: Some(1),
        tool_dispatch_ref_write_count: Some(6),
        tool_dispatch_failure_taxonomy: Default::default(),
        input_tokens: Some(0),
        uncached_input_tokens: Some(0),
        output_tokens: Some(0),
    ...
    off_report.observability_summary = Some(BossObservabilitySummary {
        ...
        total_tool_dispatch_count: 1,
        total_tool_dispatch_success_count: 1,
        total_tool_dispatch_failure_count: 0,
        total_tool_dispatch_ref_write_count: 2,
        tool_dispatch_failure_taxonomy: Default::default(),
        override_hit_count: 0,
    ...
    off_report.steps[0].routed_metadata = Some(BossStepRoutedMetadata {
        ...
        tool_dispatch_count: Some(1),
        tool_dispatch_success_count: Some(1),
        tool_dispatch_failure_count: Some(0),
        tool_dispatch_ref_write_count: Some(2),
        tool_dispatch_failure_taxonomy: Default::default(),
        input_tokens: Some(0),
        uncached_input_tokens: Some(0),
        output_tokens: Some(0),
