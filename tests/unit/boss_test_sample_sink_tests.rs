...
fn make_report(
        ...
        .map(|i| BossStepReport {
            ...
            routed_metadata: if i == 0 {
                Some(BossStepRoutedMetadata {
                    ...
                    hydration_from_contract_count: None,
                    hydration_from_ledger_count: None,
                    stale_ref_count: None,
                    hydration_ref_missing: None,
                    hydration_miss_unsupported_count: None,
                    hydration_miss_stale_count: None,
                    hydration_miss_no_match_count: None,
    ...
    let observability_summary = if cache_read > 0 || cache_write > 0 || cost_micros > 0 {
        Some(BossObservabilitySummary {
            ...
            total_hydration_from_contract_count: 0,
            total_hydration_from_ledger_count: 0,
