...
#[path = "unit/approval_protocol_tests.rs"]
mod approval_protocol_tests;
...
#[path = "unit/lism_ab_sample_tests.rs"]
mod lism_ab_sample_tests;
...
#[path = "unit/workspace_capability_bootstrap_tests.rs"]
mod workspace_capability_bootstrap_tests;
